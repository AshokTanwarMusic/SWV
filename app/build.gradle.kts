...
android {
    ...
    defaultConfig {
        ...
        // 32-bit compatibility build for Android userspaces exposing armeabi-v7a.
        // The native DSP analyzer itself is portable C++ and can be built for ARM32.
        // ONNX Runtime-backed Beat/Vocal ML features are disabled at runtime on 32-bit.
        ndk {
